...
**What M4 does NOT ship** (explicit deferrals to M5 / M8; **P0 updates base build plan `docs/specs/plan/build/build-plan-v01-36d0c6c5.md` to pin ALL of these as named commitments in the appropriate milestone section, paralleling the existing C-M5-1 / C-M5-2 items added at M3 close**):
...
**Base plan entry**: [§M4 in build plan](/root/projects/phi/phi/docs/specs/plan/build/build-plan-v01-36d0c6c5.md) — 4 lines of scope + six M4 carryovers. This plan is the fully-resolved version.
...
| D10 | **`phi project` CLI does NOT ship `--from-layout` at M4.** Deferred to M8. **P0 updates the base build plan's M8 section** (`docs/specs/plan/build/build-plan-v01-36d0c6c5.md`) to pin this commitment explicitly so it doesn't slip. | User-confirmed at plan close. Reference project layouts are per-scenario; limited fixture reuse vs org layouts. |
...
4. **Base build plan amendment** — edit `docs/specs/plan/build/build-plan-v01-36d0c6c5.md` in two sections:
...
- `docs/specs/plan/build/build-plan-v01-36d0c6c5.md` — M8 section amendment (P0) for deferred `--from-layout`.
