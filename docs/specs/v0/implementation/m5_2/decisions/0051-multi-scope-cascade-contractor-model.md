...
- **(d) Forward-scope row cross-reference**:
  - [`baby-phi/docs/specs/plan/forward-scope/remaining-scope-post-m5-p7-22035b2a.md`](../../../../plan/forward-scope/remaining-scope-post-m5-p7-22035b2a.md) lines 84–89 (CH-07 row).
