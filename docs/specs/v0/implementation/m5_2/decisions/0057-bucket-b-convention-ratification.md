<!-- Last verified: 2026-05-19 by Claude Code (CH-28 P-SEAL — §D57.7 EDGE_KIND_NAMES invariant docstring amended at L148-150 for cardinality bump 72 → 74 (NEW edge variants `AGENT_PROFILE_USES_BLUEPRINT` + `AGENT_USES_BLUEPRINT_OVERRIDE` per F1.c hybrid Blueprint table; ADR-0063 §D63.10); cycle hex `0412eb06`. Doc-only amendment; pre-existing ADR body + sub-decisions §D57.1–§D57.10 preserved verbatim.) -->
