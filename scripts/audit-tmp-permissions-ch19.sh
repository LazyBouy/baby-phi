#!/usr/bin/env bash
# Permissions-audit data extraction for CH-19 retrospective (cycle hex 2c520ba7).
# Window: 2026-05-10T09:23:07Z → 2026-05-10T12:40:21Z (UTC).
# Reads .claude/tool-use.log (JSONL); emits §A–§G aggregate counts.

set -euo pipefail

LOG="/root/projects/phi/.claude/tool-use.log"
START="2026-05-10T09:23:07Z"
END="2026-05-10T12:40:21Z"

echo "=== CH-19 permissions-audit data extraction ==="
