...
**Empirical durability (added 2026-05-18 per CH-27 retro Row 11; bumped 2026-05-20 per CH-28 retro P-doc-1, cycle hex `0412eb06`)**: Validated across **8+ consecutive cycles** (CH-18 codified → CH-28 8th-cycle re-validation; ~990+ GiB cumulative reclaimed across all cycles; **0 mid-cycle disk-pressure incidents** post-codification). CH-28 placement-1 reclaimed ~390 GiB across 6 invocations in the cycle.
